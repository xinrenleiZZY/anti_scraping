...
function updateTitle(isCollapsed) {
    ...
    if (isCollapsed) {
        ...
        // 展开时显示完整标题
        titleEl.innerHTML = '汇挚鑫-亚马逊商品排名监控系统<br><span style="font-size: 12px;">HZX-service</span>';
...
function addSidebarFooter() {
    ...
    footer.innerHTML = `
        <i class="bi bi-database" style="font-size: 14px;"></i> v2.0<br>
        <span style="font-size: 18px;">© 汇挚鑫科技</span>
    `;
