...
class SimpleRequestExecutor:
    ...
    def __init__(self, delay_range=(3, 6), postal_code="10001"):
        self.delay_range = delay_range
        self.postal_code = postal_code
        self.session = CurlSession(impersonate="chrome120")
    
        # 设置邮编 Cookie
        # self.session.cookies.set('ubid-main', '132-12345678901234567890')
        # self.session.cookies.set('session-id', '146-1234567-8901234')
    ...
    def get(self, url):
        ...
        try:
            ...
            if response and response.status_code == 200:
                ...
                elif 'cny' in preview or '￥' in preview or '¥' in preview:
...
class AmazonSearchScraper:
    ...
    def __init__(self, request_executor=None, delay_range=(3, 6), output_dir="./amazon_data", postal_code="10001"):
